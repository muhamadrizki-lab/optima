...
export default function PancaranLogo({ 
  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      {/* Pancaran Official Logo Vector Emblem */}
      <div 
      ...
      >
        ...
        >
          ...
          {/* Deep Navy Diagonal Section */}
          <path 
            d="M 45 0 L 100 0 L 100 100 L 52 100 C 52 100 68 75 68 50 C 68 25 45 0 45 0 Z" 
            fill="url(#pancaranNavy)" 
          />
          
          {/* Elegant White Swoosh/Curve */}
          <path 
            d="M 15 72 C 28 55, 48 35, 70 20 C 85 12, 92 22, 84 35 C 76 48, 55 65, 38 82 C 28 92, 18 95, 15 72 Z"
            fill="#FFFFFF"
          />
        </svg>
      </div>
